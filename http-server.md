...
* You now need to set this server in the browser add-on: visit the add-on's options
  ...
  configure `https://localhost:8082/v2` as "Other server" ([source](https://forum.languagetool.org/t/languagetool-for-safari/5554/24)).
...
You can specify a file with advanced configuration options for the LanguageTool server
